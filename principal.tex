...
\begin{resumo}[Abstract]
 \begin{otherlanguage*}{english}
   The law enforcement agencies provide a wide variety of services to citizens, but when the need for a service, the public security organs are not always physically present, and the most efficient way to contact them is by emergencies phones they offer, logo that these phones must be immune to failure. So this work is intended to show an improvement in the emergency call center of Military Police of Dourados, therefore, is being presented concepts of conventional telephony, VoIP (Voice over IP) and a hybrid tool, therefore this will have to implement the functions of a traditional telephone exchange and also, VoIP protocols, and contain features of a PBX to solve technical problems of this telemarketing thus provide security for attendants and reliability for citizens who need these emergency services.
