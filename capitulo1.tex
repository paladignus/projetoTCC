...
\begin{enumerate}
  ...
  \item Descrever os conceitos gerais sobre VoIP, seu histórico, tipos de redes, protocolos utilizados tanto na sinalização como na transmissão, vantagens, desvantagens e segurança para aplicação desta tecnologia.
