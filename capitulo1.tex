...
\begin{itemize}
	...
	\item Realizar a análise de requisitos necessário do ambiente do teleatendimento para o emprego de uma servidor PABX híbrido.
	\item Implementar um protótipo que empregue funcionalidades de PABX no teleatendimento.
	\item Propiciar o armazenamento das informações de todas as chamadas recebidas pela central telefônica.
\end{itemize}
...
Detalhando a metodologia, tem-se na primeira etapa, a fundamentação teórica. Onde exibira os conceitos sobre o sistema de telefonia pública comutada (PSTN), ou seja, o atual sistema de telefonia que conhecemos, sistema esse que serviu de base para criação da tecnologia de telefonia baseado em VoIP.
	...
	Na quarta etapa, apresentará as falhas técnicas ou mesmo humanas apontadas pelos atendentes através do emprego do questionário, bem como, pelo período de permanência para mapear o fluxo operacional e realizar à analise de requisitos para o emprego e configuração da ferramenta.
